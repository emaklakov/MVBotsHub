...
final class ForgotPasswordPage extends Page
{
    ...
    {
        $this->title(__('register.forgot_title'));
    }
    ...
    protected function components(): iterable
    {
        ...
        $components[] = ForgotPasswordForm::make(
            action: route('moonshine.password.email')
        )();
    ...
    protected function modifyLayout(\MoonShine\Contracts\UI\LayoutContract $layout): \MoonShine\Contracts\UI\LayoutContract
    {
        if ($layout instanceof LoginLayout) {
            $layout
                ->title(__('register.forgot_title'))
                ->description(__('register.forgot_description'));
        }
